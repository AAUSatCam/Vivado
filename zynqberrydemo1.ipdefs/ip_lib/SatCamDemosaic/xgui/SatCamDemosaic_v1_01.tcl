...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_COLOR_POS" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_IN_TYPE" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_MODE" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_RAW_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "RAM_ADDR_BYTE_SIZE" -parent ${Page_0}
...
proc update_PARAM_VALUE.RAM_ADDR_BYTE_SIZE { PARAM_VALUE.RAM_ADDR_BYTE_SIZE } {
	# Procedure called to update RAM_ADDR_BYTE_SIZE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.RAM_ADDR_BYTE_SIZE { PARAM_VALUE.RAM_ADDR_BYTE_SIZE } {
	# Procedure called to validate RAM_ADDR_BYTE_SIZE
	return true
}
...
proc update_MODELPARAM_VALUE.RAM_ADDR_BYTE_SIZE { MODELPARAM_VALUE.RAM_ADDR_BYTE_SIZE PARAM_VALUE.RAM_ADDR_BYTE_SIZE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.RAM_ADDR_BYTE_SIZE}] ${MODELPARAM_VALUE.RAM_ADDR_BYTE_SIZE}
}
