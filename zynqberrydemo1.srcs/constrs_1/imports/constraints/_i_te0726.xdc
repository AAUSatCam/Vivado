...
##### Fix to remove unconstrained ports
## DSI_D0_N
set_property PACKAGE_PIN F13 [get_ports {GPIO_1_tri_io[0]}]
## DSI_D0_P
set_property PACKAGE_PIN F14 [get_ports {GPIO_1_tri_io[1]}]
...
# overwrite with CAN pins.
set_property PACKAGE_PIN K15 [get_ports CAN_RX]
